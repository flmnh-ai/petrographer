...
cat("• from_pretrained() - Load detection model once for reuse\n")
...
# Load the detection model - choose one approach:

# Option A: Load from pretrained hub model (recommended for published models)
model <- from_pretrained(
  "shell_v3",  # Replace with your model ID
  confidence = config$confidence,
  device = config$device
)

# Option B: Load from local trained model directory
# model <- from_pretrained(
#   model_dir = "Detectron2_Models/your_model",
#   confidence = config$confidence,
#   device = config$device
# )
