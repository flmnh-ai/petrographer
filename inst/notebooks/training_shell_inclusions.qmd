...
validate_dataset(data_dir)
 ...
 pin_dataset(
    ...
    metadata = list(
      description = "Sliced inclusions vs shell data",
...
eval_result <- evaluate_training(model_id = model_id)
```
